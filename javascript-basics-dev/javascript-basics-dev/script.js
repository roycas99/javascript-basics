...
// image in folder;
let rose = new Image();
rose.src="img/rosaparks.png";


let martin = new Image();
martin.src = "img/martin.png";


var state = new Image();
state.src = "img/State-Flag-States-6-2015072945.png";

var police = new Image();
police.src = "img/Gerald_G_Police_man.png";

let beachDoorPath = rose.src;
let botDoorPath = police.src;
  //"https://content.codecademy.com/projects/chore-door/images/robot.svg";

let spaceDoorPath =martin.src;
